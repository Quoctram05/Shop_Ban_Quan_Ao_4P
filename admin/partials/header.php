...
if (!isset($page_title)) {
    $page_title = 'Quản Trị - Shop Quần Áo 4P';
}
if (!isset($active)) {
    $active = 'home';
}
...
<head>
    ...
    <style>
        :root {
            --primary-color: #c72002ff; /* sky-600 */
            --primary-light: #e76c0eff; /* sky-100 */
            --primary-dark: #f65e00ff;  /* sky-700 */
        }
        body { 
        ...
        #pills-canvas {
            ...
            z-index: -1; background: linear-gradient(to bottom, #e98faaff, #ad6464ff);
        }
        .sidebar-item { 
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', (event) => {
        ...
        if (canvas) {
            ...
            const colors = ['#ffffff', '#ed5605e0', '#f0f9ff', '#c10300ff'];
...
<div class="flex h-screen">
    <aside class="w-64 bg-white/80 backdrop-blur-lg shadow-lg flex flex-col p-4 border-r border-gray-200 z-10">
      <div class="flex items-center gap-3 px-2 py-4 border-b border-gray-200">
        ...
        <h1 class="text-2xl font-bold" style="color: var(--primary-dark);">4P</h1>
      </div>
